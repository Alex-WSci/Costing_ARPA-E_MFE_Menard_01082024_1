...
This Cost Category includes spare parts furnished by system suppliers for the first year of commercial operation. It excludes spare parts required for plant commissioning, startup, or the demonstration run.  Budget is \$ 87 M, which is calculated on the basis of 10 \% of the direct cost components.
...
We allocate a budget of \$ 317 M for the initial fuel load.  
...
Budget is \$ 71 M, based on 10 \% of the sum of the CSC.
