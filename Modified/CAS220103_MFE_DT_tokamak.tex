...
The total cost of the coils is 1243.0 M USD.
...
These coils serve to apply fine adjustments to the field profile to maintain field uniformity, and control any plasma disturbances. The placement, size, and magnitude of these coils is dependent upon the uniformity requirements of the plasma, and requires sophisticated FEM analysis to accurately quantify. As such, for the scope of this costing report, a simple factor of 5\% of the total primary magnet costs is taken. The resulting cost is \$47.9 M.\\
...
Radius (m) & 0.9 & 0.18 & 0.67 & 0.9 & 1.28 & 2.72 & 5.3 & 9.34 & 9.34 & 0.90 \\
...
Structural cost (M USD) & 1.4 & 7.8 & 0.8 & 1.1 & 2.6 & 5.2 & 24.4 & 64.5 & 64.5 & 64.5 \\
Quantity & 12 & 1 & 2 & 2 & 2 & 2 & 2 & 2 & 2 & 2 \\
Magnet cost (single)(M USD) & 1.4 & 7.8 & 0.8 & 1.1 & 2.6 & 5.2 & 24.4 & 64.5 & 64.5 & 64.5 \\
Magnet + structure cost (single) (M USD) & 2.7 & 15.7 & 1.7 & 2.2 & 5.3 & 10.4 & 48.7 & 128.9 & 128.9 & 128.9 \\
\hline
Total cost (M USD) & 32.6 & 15.7 & 3.3 & 4.5 & 10.6 & 20.8 & 97.4 & 257.8 & 257.8 & 257.8 \\
\hline
\end{tabular}}
