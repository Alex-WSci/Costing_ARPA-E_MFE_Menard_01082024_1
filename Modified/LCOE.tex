...
% \input{Originals/CAS700000_MIF_DT}
% \input{Originals/CAS800000_MIF_DT}
% \input{Originals/CAS900000_MIF_DT}

\input{NovatronModified/CAS700000_MIF_DT}
\input{NovatronModified/CAS800000_MIF_DT}
\input{NovatronModified/CAS900000_MIF_DT}

\subsection{Levelized Cost of Electricity} 

\begin{table}[h!] 
\begin{tabular}{l c c } 
Capital cost, $C_{AC}$ &     M\$/annum    &    839      \\ 
Scheduled Replacement Costs, $C_{SCR}$  &     M\$/annum    &  389   \\ 
Operations and Maintenance Costs, $C_{OM}$ & M\$/annum  &      472 \\ 
...
Following equation \ref{eq:coe}, the LCOE is 126 \$/MWh or 13 c/kWh. 
